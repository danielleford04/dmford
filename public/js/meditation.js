...
var stopped;
var audio = new Audio('../images/bell.wav');
...
var Entry = function(date, length, when, where, type, comments){
	this.date = date;
	this.length = +length;
	this.when = when;
	this.where = where;
...
var fiveDaysAgo = new Entry(new Date("09/27/2015"), 30, "after breakfast", "at home", "lovingkindness", "")
var fourDaysAgo = new Entry(new Date("09/28/2015"), 20)
var threeDaysAgo = new Entry(new Date("09/29/2015"), 30, "7pm", "at sitting group", "breathing meditation", "")
var twoDaysAgo = new Entry(new Date("09/30/2015"), 45)
var yesterday = new Entry(new Date("10/01/2015"), 30)

$scope.submitForm = function() {
	new Entry($scope.date, $scope.length, $scope.when, $scope.where, $scope.type, $scope.comments)
		$scope.showForm= false;
...
// --------------- Meditation Plan Form

	$scope.sunMinPlanInput = false;
	$scope.click1=function() {
		$scope.sunMinPlanInput = true;
	}
	...
	$scope.sunWhenPlanInput = false;
	$scope.click2=function() {
		$scope.sunWhenPlanInput = true;
	}
	$scope.blur2=function() {
		$scope.sunWhenPlanInput = false;
	}
	$scope.sunWhenPlan="6:30am"

	$scope.sunWherePlanInput = false;
	$scope.click3=function() {
		$scope.sunWherePlanInput = true;
	}
	$scope.blur3=function() {
		$scope.sunWherePlanInput = false;
	}
	$scope.sunWherePlan="home"
	$scope.click4=function() {
		$scope.monMinPlanInput = true;
	}
	$scope.blur4=function() {
		$scope.monMinPlanInput = false;
	}
	$scope.monMinPlan="30"

	$scope.monWhenPlanInput = false;
	$scope.click5=function() {
		$scope.monWhenPlanInput = true;
	}
	$scope.blur5=function() {
		$scope.monWhenPlanInput = false;
	}
	$scope.monWhenPlan="6:30am"

	$scope.monWherePlanInput = false;
	$scope.click6=function() {
		$scope.monWherePlanInput = true;
	}
	$scope.blur6=function() {
		$scope.monWherePlanInput = false;
	}
	$scope.monWherePlan="home"
	// 
	$scope.tueMinPlanInput = false;
	$scope.click7=function() {
		$scope.tueMinPlanInput = true;
	}
	$scope.blur7=function() {
		$scope.tueMinPlanInput = false;
	}
	$scope.tueMinPlan="70"

	$scope.tueWhenPlanInput = false;
	$scope.click8=function() {
		$scope.tueWhenPlanInput = true;
	}
	$scope.blur8=function() {
		$scope.tueWhenPlanInput = false;
	}
	$scope.tueWhenPlan="7pm"

	$scope.tueWherePlanInput = false;
	$scope.click9=function() {
		$scope.tueWherePlanInput = true;
	}
	$scope.blur9=function() {
		$scope.tueWherePlanInput = false;
	}
	$scope.tueWherePlan="IMS sitting group downtown"
	$scope.click10=function() {
		$scope.wedMinPlanInput = true;
	}
	$scope.blur10=function() {
		$scope.wedMinPlanInput = false;
	}
	$scope.wedMinPlan="20"

	$scope.wedWhenPlanInput = false;
	$scope.click11=function() {
		$scope.wedWhenPlanInput = true;
	}
	$scope.blur11=function() {
		$scope.wedWhenPlanInput = false;
	}
	$scope.wedWhenPlan="lunch"

	$scope.wedWherePlanInput = false;
	$scope.click12=function() {
		$scope.wedWherePlanInput = true;
	}
	$scope.blur12=function() {
		$scope.wedWherePlanInput = false;
	}
	$scope.wedWherePlan="work"
	// 
	$scope.thrMinPlanInput = false;
	$scope.click13=function() {
		$scope.thrMinPlanInput = true;
	}
	$scope.blur13=function() {
		$scope.thrMinPlanInput = false;
	}
	$scope.thrMinPlan="20"

	$scope.thrWhenPlanInput = false;
	$scope.click14=function() {
		$scope.thrWhenPlanInput = true;
	}
	$scope.blur14=function() {
		$scope.thrWhenPlanInput = false;
	}
	$scope.thrWhenPlan="post-workout"

	$scope.thrWherePlanInput = false;
	$scope.click15=function() {
		$scope.thrWherePlanInput = true;
	}
	$scope.blur15=function() {
		$scope.thrWherePlanInput = false;
	}
	$scope.thrWherePlan="Boulder Creek park"
	$scope.click16=function() {
		$scope.friMinPlanInput = true;
	}
	$scope.blur16=function() {
		$scope.friMinPlanInput = false;
	}
	$scope.friMinPlan="0"

	$scope.friWhenPlanInput = false;
	$scope.click17=function() {
		$scope.friWhenPlanInput = true;
	}
	$scope.blur17=function() {
		$scope.friWhenPlanInput = false;
	}
	$scope.friWhenPlan="- -"

	$scope.friWherePlanInput = false;
	$scope.click18=function() {
		$scope.friWherePlanInput = true;
	}
	$scope.blur18=function() {
		$scope.friWherePlanInput = false;
	}
	$scope.friWherePlan="DAY OFF"

	$scope.satMinPlanInput = false;
	$scope.click19=function() {
		$scope.satMinPlanInput = true;
	}
	$scope.blur19=function() {
		$scope.satMinPlanInput = false;
	}
	$scope.satMinPlan="30"

	$scope.satWhenPlanInput = false;
	$scope.click20=function() {
		$scope.satWhenPlanInput = true;
	}
	$scope.blur20=function() {
		$scope.satWhenPlanInput = false;
	}
	$scope.satWhenPlan="6:30am"

	$scope.satWherePlanInput = false;
	$scope.click21=function() {
		$scope.satWherePlanInput = true;
	}
	$scope.blur21=function() {
		$scope.satWherePlanInput = false;
	}
	$scope.sunWherePlan="home"
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			eventMouseover: function(calEvent, jsEvent, view) {
				// alert("On " + calEvent.date + " I meditated " + calEvent.length + " minutes.");
				// $scope.calEvent.date = calEvent.date;
				// $scope.calEvent.length = calEvent.length;
				document.getElementById("calendarOutput").innerHTML = "On " + (calEvent.date.getMonth()+1) + "/" + calEvent.date.getDate() + ", I meditated for " + calEvent.length +  " minutes.";
				
				if (calEvent.when != undefined || calEvent.where != undefined || calEvent.type != undefined || calEvent.comments != undefined) {
					document.getElementById("calendarOutputNotes").innerHTML = "When: " + calEvent.when + "     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Where: " + calEvent.where + "<br> Type: " + calEvent.type + "<br> Comments: " + calEvent.comments}
				else { 
					document.getElementById("calendarOutputNotes").innerHTML = ""

				}
				// else {document.getElementById("calendarOutputWhenWhere").innerHTML = ""}

				// if (calEvent.when != undefined) {
				// 	document.getElementById("calendarOutputWhen").innerHTML = "When: " + calEvent.when + ". ";}
				// if (calEvent.where != undefined) {
				// 	document.getElementById("calendarOutputWhere").innerHTML = "Where: " + calEvent.where + ". ";}
				// 	else {
				// 		document.getElementById("calendarOutputWhere").innerHTML = undefined
				// 	}
				// if (typeof calEvent.type === 'string') {
				// 	document.getElementById("calendarOutputType").innerHTML = "Type: " + calEvent.type;}
				// else {document.getElementById("calendarOutputType").innerHTML = ""}
				// // if (calEvent.comments != undefined) {
				// // 	document.getElementById("calendarOutputType").innerHTML = "Comments: " + calEvent.comments;}
